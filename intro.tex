...
The source code for this document, however, is intended to serve as
...
A consistent key format simplifies remembering how to make references. 
For example:
\begin{quote}
...
changes to the page width, such as to accommodate a larger formula. 
